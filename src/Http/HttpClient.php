...
namespace yandinovriandi\Cloudflare\Http;

use GuzzleHttp\Client;
use GuzzleHttp\Exception\RequestException;
use GuzzleHttp\HandlerStack;
use yandinovriandi\Cloudflare\Http\Exceptions\MissingParametersException;
use yandinovriandi\Cloudflare\Http\Middleware\RetryHandler;
use yandinovriandi\Cloudflare\Http\Resources\Send;
use yandinovriandi\Cloudflare\Utilities\Auth;
use yandinovriandi\Cloudflare\Exceptions\AuthException;
...
class HttpClient
{
    ...
    {
        return 'Cloudflare API PHP ' . self::VERSION;
    }
     ...
     *
     * @throws \yandinovriandi\Cloudflare\Http\Exceptions\AuthException
     * @throws \yandinovriandi\Cloudflare\Http\Exceptions\ApiResponseException
     */
